...
export default function FaqDorty() {
  ...
  return (
    <section
      ...
      id="faq-dorty"
      style={{
        backgroundImage: "linear-gradient(rgba(0,0,0,0.72), rgba(0,0,0,0.72)), url('/images/kafeterka/zakusky-stul.png')",
    ...
    >
      <div className="container">
        <div className="section-header reveal" style={{ color: "#fff" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.8)" }}>Vše, co potřebujete vědět o našich objednávkách</p>
        </div>
