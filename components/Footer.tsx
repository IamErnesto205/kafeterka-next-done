        ...
        <div className="footer-main">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-social">
              <a href="https://www.instagram.com/kafeterka/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/KAFETERKAUB" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
              ...
              <a href="https://maps.app.goo.gl/TQwQ5JPgdPNqX3Eo8" target="_blank" rel="noopener noreferrer" aria-label="Google Mapy">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
              ...
              <a href="/kontakt#kontakt-form" aria-label="Kontaktní formulář">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><a href="/dorty-na-objednavku">Dorty</a></li>
          ...
          <div className="footer-col">
            <h4>Kontakt</h4>
            <ul>
              <li><a href="#">Mariánské nám. 308, 688 01 Uherský Brod</a></li>
              <li><a href="tel:+420774295710">774 295 710</a></li>
              <li><a href="mailto:kafeterka@email.cz">kafeterka@email.cz</a></li>
            </ul>
          </div>
